...
export const Page2 = React.memo(() => {
    ...
    return (
        <div ref={ref} style={{ position: 'relative', width: '100vw', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(180deg, rgba(26,0,84,1) 5%, rgba(18,0,22,1) 100%)', overflow: 'clip' }} id="target-element">
            ...
            <div style={{ width: '90%', height: '90%', borderRadius: '1rem', display: 'flex', justifyContent: 'space-between', color: 'white' }}>
                ...
                <div style={{ width: '50%', display: 'flex', alignItems: 'center' }}>
                    <div style={{}}>
                        <motion.div
                            ...
                            <p style={{ margin: '0', fontSize: '2.1vw', fontWeight: 'bold' }}>Hello, It's me</p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            transition={{ duration: 1 }}>
                            <p style={{ margin: '0', fontSize: '3vw', fontWeight: 'bold' }}>Gabriel N.Jones</p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            transition={{ duration: 1 }}>
                            <p style={{ display: 'flex', margin: '0', fontSize: '2.1vw', fontWeight: 'bold' }}>And I'm a&nbsp;
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            transition={{ duration: 1 }}>
                            <p style={{ fontSize: '1vw', fontWeight: '700' }}>
                ...
                <div style={{ width: '40%', position: 'relative' }}>
                    <motion.div style={{ position: 'absolute', width: '60%', height: '60%', backgroundImage: `url(/page2wp/spaceBoy.webp)`, backgroundRepeat: 'no-repeat', backgroundSize: 'contain', backgroundPosition: 'center', left: '15%' }}
                        initial={{ rotate: -25 }}
                        animate={{
                            y: [100, 200, 100]
                        }}
            ...
            <motion.div style={{ position: 'absolute', width: '5%', height: '5%', top: '25%', left: '55%', zIndex: '2' }}
                animate={{
                    y: [50, 150, 50],
                    rotate: [30, -30, 30]
                }}
            ...
            <motion.div style={{ position: 'absolute', width: '5%', height: '5%', top: '50%', left: '60%', backgroundSize: 'cover', zIndex: '2' }}
                animate={{
                    y: [50, 150, 50],
                    rotate: [45, -30, 45]
                }}
